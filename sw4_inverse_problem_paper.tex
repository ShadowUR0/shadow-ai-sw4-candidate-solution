...
spanning the set.  This manuscript presents a candidate determination of which positive integers fail to occur
as such an index.  The candidate proof combines an exact rooted-forest dynamic program
...
inverse problem}, public reproducibility archive,\
\url{https://github.com/ShadowUR0/shadow-ai-sw4-candidate-solution},
SHA-256
